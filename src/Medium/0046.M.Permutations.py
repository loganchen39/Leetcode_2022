...
i= 2 , before checking if existed, perm= [1, 3]
...
i= 1 , before checking if existed, perm= [2, 3]
i= 2 , before checking if existed, perm= [2, 3]
...
i= 1 , before checking if existed, perm= [3, 2]
i= 2 , before checking if existed, perm= [3, 2]
before perm.pop(), perm= [3, 2]
i= 2 , before checking if existed, perm= [3]
